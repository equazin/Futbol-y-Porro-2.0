...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Futbol y Porro FC — Futbol para siempre" },
      { name: "description", content: "La app del Futbol y Porro FC. Un club de amigos, cultivo propio y responsable. Anotate al próximo partido." },
