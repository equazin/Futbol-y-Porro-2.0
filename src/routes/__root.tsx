...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Picado — Organizá tu picado sin quilombo" },
      { name: "description", content: "App para organizar partidos de fútbol amateur entre amigos. Publicá el próximo picado, anotate con un toque y enterate al toque quién juega." },
      { property: "og:title", content: "Picado" },
