...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Futbol y Porro FC — Organizá tu picado sin quilombo" },
      { name: "description", content: "La app del Futbol y Porro FC. Anotate al próximo picado, mirá quién juega y seguí el ranking del grupo." },
      { property: "og:title", content: "Futbol y Porro FC" },
      { property: "og:description", content: "La app del Futbol y Porro FC. Anotate al próximo picado." },
